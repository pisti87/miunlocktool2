...
def get_hungarian(self):
    return {
        ...
        'desc': (
            f"Automatikus feloldási kérelem küldő eszköz\n"
            f"Készítette: Vozduhan\n"
            f"Verzió: {self._get_version()}"
        ),
        'desc_manual': (
            f"Kézi mód – add meg a küldés időpontját\n"
            f"Készítette: Vozduhan\n"
            f"Verzió: {self._get_version()}"
        ),
        'params': "Paraméterek",
        ...
        'log_request_parse_error': "[Hiba] JSON feldolgozás sikertelen: {data}",
        'log_request_failed_no_response': "[Hiba] Nincs válasz a szervertől",
        'log_request_exception': "[Hiba] Kérés sikertelen: {error}",
        'cookie_label': "ServiceToken:",
        'cookie_placeholder': "Illeszd be a tokent...",
        'confirm': "Elfogadom a lehetséges tiltás kockázatát",
        'info': "Információ",
        'status_ready': "Indításra kész",
        'ping': "Ping: nincs mérve",
        'time': "Idő: nincs szinkronizálva",
        'start_btn': "Indítás",
        'instructions_btn': "Útmutató",
        'exit_btn': "Kilépés",
        'log': "Napló",
        'clear_log_btn': "Törlés",
        'unlock_start': "Feloldás indítása...",
        'device_id_gen': "DeviceId létrehozva: {}",
        'ping_start': "Ping mérés indítása...",
        'ping_server': "{} ping: {:.2f} ms",
        'ping_failed': "Ping nem sikerült: {}",
        'ping_error': "Ping hiba {}: {}",
        'ping_default': "Ping sikertelen, alapérték: {} ms",
        'open_miflash': "MiFlash Unlock",
        'ping_avg': "Átlagos ping: {:.2f} ms",
        'ntp_connect': "Kapcsolódás NTP szerverhez: {}",
        'ntp_time': "Peking idő: {} ({})",
        'ntp_failed': "Nem sikerült időt szinkronizálni.",
        'time_wait': "Várakozás (23:59:50)...",
        'target_time': "Várakozás eddig: {} (ping: {} ms)",
        'target_time_manual': "Várakozás eddig: {}",
        'time_reached': "Idő elérve: {} – küldés indul...",
        'cookie_skipped': "Token ellenőrzés kihagyva",
        'cookie_expired': "Token lejárt, frissítsd!",
        'account_ready': "[Állapot] Küldhető kérelem.",
        'account_blocked': "[Állapot] Tiltva eddig: {}.",
        'account_new': "[Állapot] A fiók túl új.",
        'account_approved': "[Állapot] Jóváhagyva eddig: {}.",
        'account_unknown': "[Hiba] Ismeretlen állapot",
        'status_error': "[Hiba] Állapot lekérési hiba: {}",
        'request_sent': "\nKérelem elküldve: {}",
        'response_received': "Válasz érkezett: {}",
        'request_failed': "[Hiba] Küldés sikertelen",
        'response_error': "[Hiba] Válasz feldolgozási hiba: {}",
        'request_error': "[Hiba] {}",
        'confirm_warning': "Erősítsd meg a folytatáshoz!",
        'cookie_error': "Adj meg tokent!",
        'time_error': "Idő szinkronizálás sikertelen!",
        'settings_saved': "\nBeállítások mentve:",
        'cookie_check': "Token ellenőrzés: {}",
        'default_ping': "Alap ping: {} ms",
        'ping_note': "Hiba esetén ez lesz használva.",
        'saved': "Mentve",
        'instructions_title': "Útmutató",
        'about_title': "Névjegy",
        'about_content': (
            f"Bootloader feloldó eszköz\n"
            f"Xiaomi HyperOS eszközökhöz\n\n"
            f"Verzió: {self._get_version()}"
        ),
        'general_title': "Követelmények",
        'general_content': (
            "• Fiók legalább 30 napos\n"
            "• Régió: Global\n"
            "• Nem működik CN ROM-mal\n"
            "• HyperOS szükséges"
        ),
        'firefox_title': "Firefox / Edge",
        'firefox_content': "Használd a Cookie Editor bővítményt és másold ki a tokent.",
        'chrome_title': "Chrome",
        'chrome_content': "Futtasd a scriptet a böngészőben és másold ki a tokent.",
        'trouble_title': "Hibaelhárítás",
        'trouble_content': "Frissítsd az oldalt vagy jelentkezz ki/be.",
        'authors_title': "Készítők",
        'authors_content': "Vozduhan",
        'cookie_checkbox': "Token ellenőrzés kikapcsolása",
        'ping_label': "Alap ping (ms)",
        'color_theme_label': "Szín téma",
        'color_theme_xiaomi_orange': "Narancs",
        'color_theme_red_sun': "Piros",
        'color_theme_blue_world': "Kék",
        'save_btn': "Mentés",
        'close_btn': "Bezárás",
        'settings': "Beállítások",
        'auto_mode': "Automatikus",
        'manual_mode': "Kézi",
        'manual_time_label': "Idő (mp)",
        'manual_time_hint': "58.5 - 59.8",
        'manual_mode_start': "Küldés: 23:59:{}",
        'manual_time_error': "Hibás idő",
        'application_not_submitted': "[Állapot] Limit elérve, próbáld újra: {}",
        'device_binding_hint': "Kösd össze az eszközt a beállításokban",
        'theme_label': "Téma",
        'theme_system': "Rendszer",
        'theme_light': "Világos",
        'theme_dark': "Sötét",
        'mode_label': "Mód",
        'cookies_title': "Token beszerzés",
        'expand_cookies': "▶ Token",
        'collapse_cookies': "▼ Token",
        'check_updates': "Frissítés keresése",
        'update_available': "Új verzió elérhető",
        'update_not_available': "Naprakész",
        'update_checking': "Ellenőrzés...",
        'update_error': "Hiba",
        'current_version': "Verzió: {}",
        'latest_version': "Legújabb: {}",
        'update_btn_ok': "OK",
        'update_btn_update': "Frissítés",
        'update_message': "Új verzió: {} – megnyissam?",
        ...
        'welcome_text': (
            ...
            "A használat tiltást okozhat."
        ),
        'welcome_btn': "Tovább",
        'language_label': "Nyelv",
        'log_to_txt_checkbox': "Napló mentése",
        'spam_mode_checkbox': "Spam mód",
        'spam_mode_desc': "Több kérelem küldése rövid időközönként.",
        'ping_not_measured_manual': "Ping: nincs mérve",
        'log_auto_mode_spam_selected': "Auto mód (spam)",
        'log_auto_mode_single_selected': "Auto mód",
        'log_manual_mode_selected': "Kézi mód",
        'log_time_gt_2355': "Idő > 23:58, szinkron...",
        'log_time_sync_success': "Szinkron kész",
        'log_ping_wait': "Ping mérésre vár...",
        'status_ping_wait': "Várakozás pingre...",
        'log_ping_time_passed': "Ping idő elmúlt, mérés...",
        'log_ping_start': "Ping mérés...",
        'log_measuring_ping': "Ping mérés folyamatban...",
        'log_ping_measured': "Ping: {} ms",
        'log_time_updated': "Idő frissítve: {}",
        'log_resync_error': "Szinkron hiba",
        'log_normal_mode_ping': "Ping számítás...",
        'log_calculated_send_time': "Küldési idő: 23:59:{}",
        'log_spam_mode_targets': "Spam időpontok: {}",
        'status_spam_wait': "Spam várakozás...",
        'log_spam_sending_at': "[Spam {}] Küldés: 23:59:{}",
        'log_spam_new_device_id': "[Spam {}] Új deviceId: {}",
        'log_spam_response_prefix': "[Spam {}] Idő: {}",
        'log_spam_success_prefix': "SIKER!",
        'log_spam_response_format': "{} | {} | {}",
        'log_spam_parse_error': "[Spam {}] Hiba: {}",
        'log_spam_no_response': "[Spam {}] Nincs válasz",
        'log_spam_send_error': "[Spam {}] Küldési hiba: {}",
        'login_title': "Bejelentkezés",
        'login_user_label': "Fiók / Email / Telefon",
        'login_user_placeholder': "Add meg",
        'login_pwd_label': "Jelszó",
        'login_pwd_placeholder': "********",
        'wb_instruction': "Nyisd meg az oldalt és másold ki a linket.",
        'wb_instruction_after_open': "Illeszd be a linket.",
        'wb_id_label': "Link",
        'wb_id_placeholder': "Ide illeszd",
        'open_confirmation_page': "Megnyitás",
        'login_button': "Bejelentkezés",
        'logging_in': "Bejelentkezés...",
        'login_fields_error': "Tölts ki minden mezőt!",
        'login_success': "Sikeres bejelentkezés",
        'login_failed': "Sikertelen bejelentkezés",
        'login_failed_generic': "Hibás adatok",
        'login_token_extract_error': "Token nem található",
        'mi_unlock_title': "Mi Unlock Tool",
        'mi_unlock_checking_python': "Python ellenőrzés...",
        'mi_unlock_python_found': "Python: {}",
        'mi_unlock_python_not_found': "Python hiányzik!",
        'mi_unlock_python_error_msg': "Telepíts Python 3.8+ verziót.",
        'mi_unlock_installing': "Telepítés...",
        'mi_unlock_install_cmd': "pip install miunlock",
        'mi_unlock_already_installed': "Már telepítve",
        'mi_unlock_install_success': "Kész",
        'mi_unlock_install_error': "Hiba",
        'mi_unlock_starting': "Indítás...",
        'mi_unlock_launching': "Futtatás...",
        'mi_unlock_file_not_found': "Nem található: {}",
        'mi_unlock_not_found': "Nincs telepítve",
        'mi_unlock_completed': "Kész",
        'mi_unlock_finished': "Befejezve",
        'mi_unlock_error': "Hiba: {}",
        'mi_unlock_critical_error': "Kritikus hiba: {}",
        'mi_unlock_close': "Bezárás",
        'mi_unlock_input_label': "Bemenet",
        'mi_unlock_input_placeholder': "Írj és Enter",
        'mi_unlock_send_btn': "Küldés",
        'mi_unlock_input_prefix': "→ {}",
        'mi_unlock_input_error': "Hiba: {}",
        'mi_unlock_stdout_error': "Stdout hiba",
        'mi_unlock_stderr_error': "Stderr hiba",
        'mi_unlock_auto_sending': "→ Enter",
        'mi_unlock_auto_send_error': "Hiba",
        'mi_unlock_read_error': "Olvasási hiba",
        'mi_unlock_process_exit': "Kilépési kód: {}",
        'mi_unlock_initial_enter': "→ Start",
        'mi_unlock_auto_send_final': "→ Vége",
    }
